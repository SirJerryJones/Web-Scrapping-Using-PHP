<?php require_once 'inc/scrapper.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="card">
                    <div class="card-content">
                        <span class="card-title">
                            ...
                            <button class="btn btn-small waves-effect waves-light grey" onclick="fbs_click('<?=$job['link']?>', '<?=$job['title']?>')" name="action">
                                <i class="fa fa-facebook" aria-hidden="true"></i>
                            </button>
                            <button class="btn btn-small waves-effect waves-light grey" onclick="window.open('http://twitter.com/share?text=<?=$job['title']?>&url=<?=$job['link']?>&via=Civika-HiringThing','','scrollbars=no,menubar=no,height=450,width=650,resizable=yes,toolbar=no,location=no,status=no')" name="action">
                                <i class="fa fa-twitter" aria-hidden="true"></i>
                            </button>
                            <button class="btn btn-small waves-effect waves-light grey" onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&url=<?=$job['link']?>&title=<?=$job['title']?>&summary=<?=urlencode($job['description'])?>&source=Civika-HiringThing')" name="action">
                                <i class="fa fa-linkedin" aria-hidden="true"></i>
                            </button>
                        </span>
                        <div class="row">
                        <div class="col s6 mb-2"><span class="job-location"><?php if(isset($job['location'])){ echo $job['location']; }?></span></div>
                        <div class="col s6 mb-2"><a href="<?=$job['link']?>" class="waves-effect waves-light btn-small black-text grey lighten-2 right" target="_blank">Learn More</a></div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <p><?=$job['description']?></p>
